...
def get_messari_asset_roi(
    ...
    """
    Get Return-on-Investment (ROI) data for specified assets from the Messari API.
    ...
    Returns:
        JSON string containing list of assets with their ROI data
