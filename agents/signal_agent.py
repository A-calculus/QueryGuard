...
import yaml
from typing import List, Dict, Any, Optional, Annotated, Sequence, TypedDict, Union
import json
...
class MistralToolModel(Runnable):
    ...
    def load_prompt_config():
        ...
        try:
            with open('prompts/signal_prompt.yaml', 'r') as file:
    ...
    def _load_tools(self) -> Dict[str, Any]:
        ...
        try:
            with open('tools/signal_tools.yaml', 'r') as file:
...
class SignalAgent:
    ...
    def _load_config(self) -> Dict[str, Any]:
        with open("prompts/signal_prompt.yaml", "r") as f:
    ...
    def _create_graph(self) -> Graph:
        def decide_next_action(state: SignalState) -> SignalState:
        ...
        def call_tool(state: SignalState) -> SignalState:
            messages = state["messages"]
        ...
        def finalize(state: SignalState) -> SignalState:
            messages = state["messages"]
...
async def signal_agent(user_input: str) -> str:
    """Factory function to create and use the SignalAgent."""
    agent = SignalAgent()
    return await agent.get_response(user_input)
