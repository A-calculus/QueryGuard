...
class MistralToolModel(Runnable):
    ...
    def load_prompt_config():
        ...
        try:
            with open('prompts/market_prompt.yaml', 'r') as file:
    ...
    def _load_tools(self) -> Dict[str, Any]:
        ...
        try:
            with open('tools/market_tools.yaml', 'r') as file:
...
class MarketAgent:
    ...
    def _load_config(self) -> Dict[str, Any]:
        with open("prompts/market_prompt.yaml", "r") as f:
    ...
    def _create_graph(self) -> Graph:
        def decide_next_action(state: MarketState) -> MarketState:
        ...
        def call_tool(state: MarketState) -> MarketState:
            messages = state["messages"]
        ...
        def finalize(state: MarketState) -> MarketState:
            messages = state["messages"]
...
async def market_agent(user_input: str) -> str:
    """Factory function to create and use the MarketAgent."""
    agent = MarketAgent()
